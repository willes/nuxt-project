<template>
    <el-scrollbar native height="90vh" view-style="padding: 12px">
    <el-row :gutter="20">
      <el-col
...
async function fetchData() {
  const { data, error } = await useFetch("/api/article"); // https://front-gateway.mtime.com/ticket/schedule/showing/movies.api?locationId=290
  if (error.value) {
